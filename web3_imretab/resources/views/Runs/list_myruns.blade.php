...
<div class="container d-flex align-items-center justify-content-center text-center p-5">
    <div class="text-white bg-dark p-5 border border-3 border-secondary rounded-lg">
        ...
        <h1 class="mb-3">Edit Run</h1>
        <h5 class="mb-4">Site where you can modify your runs if it is rejected or you have some misinformation</h5>
            ...
            <div class="row border border-2 border-secondary">
                ...
                <div class="col border-end border-secondary"><a href="/edit-my-run/{{$runs->id}}" class="btn btn-success">Edit run</a></div>
            </div>
            <br>
            @endforeach
        <!--<div class="row p-5">
